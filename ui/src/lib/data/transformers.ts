...
export const normalizeClip = (raw: any): Clip => {
  ...
  const clip: Clip = {
    ...
    formation: toStringOrUndefined(raw?.formation),
    ...
    ballScreen: toStringOrUndefined(raw?.ball_screen ?? raw?.ballScreen),
    offBallScreen: toStringOrUndefined(raw?.off_ball_screen ?? raw?.offBallScreen),
    helpRotation: toStringOrUndefined(raw?.help_rotation ?? raw?.helpRotation),
    disruption: toStringOrUndefined(raw?.disruption),
    ...
    paintTouches: toStringOrUndefined(raw?.paint_touch ?? raw?.paintTouch),
    rebound: toStringOrUndefined(raw?.rebound ?? raw?.rebound_outcome),
